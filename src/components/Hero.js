...
export const Hero = () => {
  return (
    <div className="relative isolate overflow-hidden h-screen bg-black opacity-6">
      <Image
          src="/hero-background.avif"
          width={800}
          height={800}
          alt="https://unsplash.com/photos/sOkZ3oSJ2RE"
          className="absolute hidden sm:block inset-0 -z-10 text-black opacity-30 h-auto w-auto sm:h-full sm:w-full object-cover"
      />
      <Image
          src="/mobile-background.png"
          fill
          alt="https://unsplash.com/photos/sOkZ3oSJ2RE"
          className="absolute block sm:hidden inset-0 -z-10 text-black opacity-70 h-auto w-auto sm:h-full sm:w-full object-cover"
      />
