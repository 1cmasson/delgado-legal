...
export const Hero = () => {
  return (
    <div className="relative isolate overflow-hidden bg-hero bg-contain h-[44rem] md:bg-cover bg-no-repeat bg-fixed md:h-screen md:bg-desktop">
      <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-lg lg:flex-shrink-0 lg:pt-8">
          <h1 className="mt-20 text-4xl text-center font-bold tracking-tight text-white sm:text-6xl">
